...
export function ShareArticle({ publicUrl }: { publicUrl: string }) {
  ...
  return (
    <View className="flex-row justify-end gap-2 mb-2 pr-2 md:hidden">
      ...
      <Button size="sm" className="flex-row gap-2" variant="secondary" onPress={() => sharePdfWithNativeApp(publicUrl)}>
